...
// font lines for testing
    ...
    // uncomment line, that you want to see
...
//        drawLine(0f, paint.ascent()+lineBaseline, width + 0f, paint.ascent()+lineBaseline, Paint().apply { color = Color.LTGRAY })
//        drawLine(0f, paint.descent()+lineBaseline, width + 0f, paint.descent()+lineBaseline, Paint().apply { color = Color.DKGRAY })
    }
}